...
const enMessages = {
  ...
  "projects.overviewIntro":
    "A focused selection of anonymized case studies that reflect my current architecture ownership across frontend, backend, CMS integration, and deployment delivery.",
  "projects.overviewBody":
    "These case studies highlight system boundaries, multilingual routing, GraphQL proxy patterns, deployment safety, reusable boilerplate strategy, and delivery governance without exposing client-sensitive details.",
  "projects.catalogHint":
    "Public GitHub repositories remain available in the vertical project catalog sections.",
  "projects.caseStudiesEyebrow": "Case Study",
  "projects.caseStudiesAria": "Architecture case studies",
  "projects.caseStudy.architecture": "Architecture",
  "projects.caseStudy.delivery": "Delivery Model",
  "projects.caseStudy.stack": "Stack",
...
const deMessages: typeof enMessages = {
  ...
  "projects.overviewIntro":
    "Eine gezielte Auswahl anonymisierter Case Studies, die meine aktuelle Architekturverantwortung über Frontend, Backend, CMS-Integration und Deployment hinweg zeigen.",
  "projects.overviewBody":
    "Diese Case Studies verdeutlichen Systemgrenzen, mehrsprachiges Routing, GraphQL-Proxy-Muster, Deployment-Sicherheit, wiederverwendbare Boilerplate-Strategien und Delivery-Governance, ohne sensible Kundendetails offenzulegen.",
  "projects.catalogHint":
    "Öffentliche GitHub-Repositories bleiben in den vertikalen Projektkatalog-Bereichen verfügbar.",
  "projects.caseStudiesEyebrow": "Case Study",
  "projects.caseStudiesAria": "Architektur-Case-Studies",
  "projects.caseStudy.architecture": "Architektur",
  "projects.caseStudy.delivery": "Delivery-Modell",
  "projects.caseStudy.stack": "Stack",
  "projects.caseStudy.outcome": "Ergebnis",
