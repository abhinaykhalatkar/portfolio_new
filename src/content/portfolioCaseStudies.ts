...
export const portfolioCaseStudies: CaseStudySummary[] = [
  ...
  },
  {
    ...
    deliveryModel: {
      en: "Built and maintained at scribble Werbeagentur as the sole engineer. The headline delivery: an in-place Craft CMS 4→5 migration of the live, order-taking commerce database with zero data loss — 153 database migrations rehearsed on a production replica, then a staged go-live runbook with per-stage rollbacks. Server-side form hardening with honeypots and mandatory GDPR consent validation; tracker-free, cookie-minimal build.",
